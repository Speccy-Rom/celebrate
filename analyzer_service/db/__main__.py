...
from analyzer_service.utils.pg import DEFAULT_PG_URL, make_alembic_config
...
def main():
    ...
    alembic.parser.add_argument(
        '--pg-url', default=os.getenv('ANALYZER_SERVICE_PG_URL', DEFAULT_PG_URL),
        help='Database URL [env var: ANALYZER_SERVICE_PG_URL]'
    )
