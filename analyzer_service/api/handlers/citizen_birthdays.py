"""Вычисляем число подарков, которое приобретет каждый житель
 выгрузки своим родственникам (первого порядка),
...
from analyzer_service.api.schema import CitizenPresentsResponseSchema
from analyzer_service.db.schema import (
