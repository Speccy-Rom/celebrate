...
from analyzer_service.api.schema import PatchCitizenResponseSchema, PatchCitizenSchema
from analyzer_service.db.schema import citizens_table, relations_table
