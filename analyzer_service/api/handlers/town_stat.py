"""Вычисляем 50-й, 75-й и 99-й перцентили возрастов (полных лет) жителей по городам в указанной выборке."""
...
from analyzer_service.api.schema import TownAgeStatResponseSchema
from analyzer_service.db.schema import citizens_table
from analyzer_service.utils.pg import rounded
